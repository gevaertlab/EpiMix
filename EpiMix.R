...
EpiMix <- function(methylation.data,
  ...
  if(mode == "regular"){
    ...
    met.data <- split.met.data(methylation.data, sample.info, group.1, group.2)
    MET_Experiment <- met.data$MET_Experiment
    MET_Control <- met.data$MET_Control
