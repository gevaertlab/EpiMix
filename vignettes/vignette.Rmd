...
### 5.2 Genome-browser style visulization

#### 5.2.1 Integrative visulization of the chromatin state, DNA methylation, and transcript structure of a specific gene
...
![Integrative visulization of the chromatin state, DM values and the transcript structure of the *CCND2* gene. The differential methylation (DM) value represents the mean difference in beta values between the hypermethylated samples versus the normally methylated samples](figures/CCND2.png)
